...
type Repository interface {
	...
	GetCustomerByUserID(ctx *gin.Context, tx *sql.Tx, userID string) (userDomain.Customer, error)
	GetSellerByID(ctx *gin.Context, tx *sql.Tx, sellerID string) (userDomain.Seller, error)
	GetSellerByUserID(ctx *gin.Context, tx *sql.Tx, userID string) (userDomain.Seller, error)
