...
type Usecase interface {
	...
	InsertProduct(ctx *gin.Context, product httpCommon.ProductRequest) error
	...
	InsertCartProduct(ctx *gin.Context, cartProduct httpCommon.AddCartProduct) error
	InsertPayment(ctx *gin.Context, payment httpCommon.Payment) error
	InsertImages(ctx *gin.Context) (imagesID []string, err error)
	UpdateProductByID(ctx *gin.Context, productID string, product httpCommon.ProductRequest) error
	UpdateOrderStatusByID(ctx *gin.Context, updateOrderStatus httpCommon.UpdateOrderStatus) error
